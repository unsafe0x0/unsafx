...
export function ChatHeader({ onNewChat, onOpenHistory }: ChatHeaderProps) {
  return (
    <header className="fixed top-4 left-0 right-0 z-10 px-4">
      <div className="max-w-4xl mx-auto flex items-center justify-between px-6 py-3 bg-background/10 backdrop-blur-sm border border-border rounded-xl transition-all">
